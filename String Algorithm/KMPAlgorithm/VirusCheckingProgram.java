...
public class VirusCheckingProgram extends kmpAlgorithm{	
	...
	public void runAlgorithm(File f) throws IOException { 
		...
		for(int i=0;i<Malware.size();i++) {
			...
			KMP(ProgramCode,Malware.get(i));
			long end = System.nanoTime();
			int numOfMatching = KMP(ProgramCode,Malware.get(i));
	...
	public void showResult() {
		...
		System.out.println("KMP 알고리즘 실행시간 : " + ((double)sum)/ 1000000 +"ms");
		System.out.println();
